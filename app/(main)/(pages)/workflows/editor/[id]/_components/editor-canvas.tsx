...
const EditorCanvas = (props: Props) => {
  ...
  const handleDeleteNode = useCallback(
    (nodeId: string) => {
      ...
      // Optionally, clear selection if the deleted node was selected
    ...
    [setNodes, setEdges, state.editor.selectedNode, dispatch]
  );
  ...
  }, [state.editor.selectedNode, handleDeleteNode]);
