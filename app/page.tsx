...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center w-full min-h-screen bg-neutral-950">
      <Navbar />
      <section className="w-full bg-neutral-950 rounded-md relative flex flex-col items-center antialiased pt-8 pb-16 px-4">
        <div className="absolute inset-0 h-full w-full [background:radial-gradient(125%_125%_at_50%_10%,#000_35%,#223_100%)] pointer-events-none z-0"></div>
            ...
            titleComponent={
              <div className="flex flex-col items-center">
                ...
                <h1 className="text-5xl md:text-8xl bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-600 font-sans font-bold text-center">
                  Automate Your Work With autoRobo
                </h1>
              </div>
            }
            children={
      ...
      <section className="w-full flex justify-center py-12 h-full">
        <InfiniteMovingCards
          className="md:mt-[-14rem] mt-[-150px]"
          items={clients}
          direction="right"
          speed="slow"
        />
      ...
      <section className="w-full h-full flex flex-col items-center justify-center py-24 bg-transparent">
        <LampComponent />
