...
const MenuOptions = (props: Props) => {
  ...
  return (
    <>
      ...
      <nav className=" dark:bg-black h-screen overflow-scroll justify-between flex items-center flex-col py-2 px-2">
        <div className="flex items-center justify-center flex-col gap-4 pt-2">
          ...
          <Separator />
          <div className="flex items-center flex-col gap-8 dark:bg-[#353346]/30 py-4 px-2 rounded-full h-48 overflow-scroll border-1 border-gray-800 *:border-gray-800">
            <div className="relative dark:bg-[#353346]/70 p-2 rounded-full dark: border-[1px] dark:border-t-[#353346]">
